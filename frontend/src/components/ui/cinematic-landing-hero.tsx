...
function TypewriterText({ text }: { text: string }) {
  ...
  return (
    <span className="inline-block relative text-center">
      <span style={{ opacity: started ? 1 : 0, transition: 'opacity 0.2s', color: 'white' }}>{displayText}</span>
      <span className="absolute ml-1 animate-pulse opacity-50 text-indigo-400 font-light" style={{ color: '#818cf8' }}>|</span>
    </span>
  );
}
...
export function CinematicHero({ 
  brandName = "COMMGEN",
  tagline1 = "#COMMGEN",
  tagline2 = "Comments we got you covered",
  cardHeading = "Documentation, automated.",
  cardDescription = <><span className="text-white font-semibold">COMMGEN</span> empowers developers with structured, AI-generated code comments, precise AST token mapping, and beautiful contextual insights.</>,
  metricValue = 200,
  metricLabel = "ms/file Speed",
  ctaHeading = "Write Code. We Handle the Documentation.",
  ctaDescription = "Automatically generate clean comments and explanations for your code using AI. Save hours of manual documentation.",
  className, 
  ...props 
}: CinematicHeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="hero-text-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 will-change-transform transform-style-3d">
        ...
        <h1 className="text-white text-center text-3xl md:text-5xl lg:text-[4rem] font-extrabold tracking-tighter mt-4 min-h-[1.5em] flex items-center justify-center drop-shadow-[0_0_15px_rgba(255,255,255,0.3)]">
          <TypewriterText text={tagline2} />
        </h1>
      </div>
      ...
      <div className="cta-wrapper absolute z-10 flex flex-col items-center justify-center text-center w-screen px-4 gsap-reveal pointer-events-auto will-change-transform">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <a href="#" aria-label="Download COMMGEN" className="btn-modern-light flex items-center justify-center gap-3 px-10 py-4 rounded-[1.25rem] group focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
            {/* Download Icon SVG */}
            <svg className="w-7 h-7 transition-transform group-hover:translate-y-0.5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div className="mockup-scroll-wrapper order-2 lg:order-2 relative w-full h-[380px] lg:h-[600px] flex items-center justify-center z-10" style={{ perspective: "1000px" }}>
              ...
              <div className="relative w-full h-full flex items-center justify-center transform scale-[0.65] md:scale-85 lg:scale-100">
                    ...
                    <div className="relative w-full h-full pt-12 px-5 pb-8 flex flex-col">
                      <div className="phone-widget flex justify-between items-center mb-8">
                        <div className="flex flex-col">
                          ...
                          <span className="text-xl font-bold tracking-tight text-white drop-shadow-md">Response Time</span>
                        </div>
                ...
                <div className="floating-badge absolute flex top-6 lg:top-12 left-[-15px] lg:left-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">100% Documented</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Fully covered</p>
                  </div>
                </div>
                ...
                <div className="floating-badge absolute flex bottom-12 lg:bottom-20 right-[-15px] lg:right-[-80px] floating-ui-badge rounded-xl lg:rounded-2xl p-3 lg:p-4 items-center gap-3 lg:gap-4 z-30">
                  ...
                  <div>
                    <p className="text-white text-xs lg:text-sm font-bold tracking-tight">CI/CD Ready</p>
                    <p className="text-blue-200/50 text-[10px] lg:text-xs font-medium">Pipeline integrated</p>
                  </div>
                </div>
