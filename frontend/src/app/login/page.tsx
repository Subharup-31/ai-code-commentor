...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-[#a855f7]/10 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="w-full max-w-md z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-white/50 text-sm">Sign in to access the CodeComm Engine</p>
        </div>
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            <div>
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3.5 text-white placeholder:text-white/30 outline-none focus:border-[#a855f7] focus:ring-1 focus:ring-[#a855f7] transition-all"
              />
            </div>
            <div>
              <input
              ...
              <div className="flex justify-end mt-2">
                <Link href="/forgot-password" className="text-sm font-medium text-[#a855f7] hover:text-[#c084fc] transition-colors">
                  Forgot password?
                </Link>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full mt-2 bg-gradient-to-r from-[#10b981] to-[#a855f7] text-white font-bold py-3.5 rounded-xl hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center"
            >
              {loading ? (
